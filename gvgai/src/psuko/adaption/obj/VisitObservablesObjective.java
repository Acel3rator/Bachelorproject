...
public class VisitObservablesObjective extends AbstractGVGStateObjective {
...
//	private final int sameObsIDCounterMax;
	...
	public VisitObservablesObjective(ObservableType obsType, int tabooTime, ValueType valType) {
		super("visit" + obsType.toString(), Sign.MAXIMIZE);
...
//	public double keepDist(StateObservation actualState, ArrayList<Observation> obsList)
//	{
...
//		int counter = 0;
//		
//		Vector2d avPos = actualState.getAvatarPosition();
//		
